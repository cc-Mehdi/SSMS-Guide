...
6. قابلیت IntelliSense: از IntelliSense برای تکمیل خودکار کد و پیشنهادات استفاده کنید. Ctrl+Space را فشار دهید تا IntelliSense را فعال کنید و لیستی از اشیاء و کلمات کلیدی موجود را دریافت کنید.
