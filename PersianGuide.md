...
10. قابلیت IntelliSense: SSMS IntelliSense را ارائه می دهد که تکمیل کد و پیشنهادات را در حین تایپ ارائه می دهد. می‌توانید گزینه‌های IntelliSense را در زیر `«ابزارها» > «گزینه‌ها» > «ویرایشگر متن» > «Transact-SQL» > «IntelliSense»` تنظیم کنید.
