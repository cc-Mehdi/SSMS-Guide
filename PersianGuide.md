...
تعیین نقش: SQL Server نقش‌های داخلی مختلفی را ارائه می‌کند (به عنوان مثال، db_owner، db_datareader، db_datawriter) که مجموعه‌های خاصی از مجوزها را تعریف می‌کنند. نقش های مناسب را به کاربران اختصاص دهید تا دسترسی های لازم را فراهم کنند.
